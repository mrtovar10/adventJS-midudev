...
export default function sumPairs(numbers, result) {
    ...
    let arrayDeNumeros = [...numbers]
    let array = []
    for (let i = 0; i < numbers.length ; i++) {
        array.push(arrayDeNumeros.shift())
        let segundoValor = arrayDeNumeros.filter(valor => valor === result - array[0])
        array = [array[0], segundoValor[0]]
