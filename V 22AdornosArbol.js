...
export default function countDecorations(bigTree) {
    ...
    if(!bigTree.left && bigTree.right) return bigTree.value + countDecorations(bigTree.right)
    if(bigTree.left && !bigTree.right) return bigTree.value + countDecorations(bigTree.left)
